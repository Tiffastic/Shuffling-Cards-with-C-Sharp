...
namespace A03Cards
{
    class Program
    {
        ...
        private static List<Card> TestDeck()
        {
            ...
            // Royal Flush
            testDeck.Add(new Card(Rank.Ace, Suit.Hearts));
            testDeck.Add(new Card(Rank.King, Suit.Hearts));
            testDeck.Add(new Card(Rank.Queen, Suit.Hearts));
            testDeck.Add(new Card(Rank.Jack, Suit.Hearts));
            testDeck.Add(new Card(Rank.Ten, Suit.Hearts));
            ...
            testDeck.Add(new Card(Rank.Jack, Suit.Diamonds));
